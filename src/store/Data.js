...
export const TASK_DEFINITIONS = [
    ...
    { id: 'unbox_generator', description: 'Unbox Diesel Generator', requiredSkill: 'Hardware Technician', requiredHardware: { 'generator_diesel_50kw': 1 }, durationMinutes: 90, location: 'Tech Room', onCompleteEffect: { action: 'STAGE_HARDWARE', item: 'generator_diesel_50kw' } },
    ...
    { id: 'install_generator', description: 'Install Diesel Generator', requiredSkill: 'Hardware Technician', durationMinutes: 300, location: 'Utility Yard', needsStaged: 'generator_diesel_50kw', onCompleteEffect: { action: 'INSTALL_HARDWARE' } },
    ...
    { id: 'install_router', description: 'Install Enterprise Router', requiredSkill: 'Network Engineer', durationMinutes: 75, location: 'Server Room', needsStaged: 'router_enterprise_01', needsTarget: 'RACK_POWERED', onCompleteEffect: { action: 'INSTALL_HARDWARE' } },
    { id: 'install_fiber_terminal', description: 'Install Fiber Terminal', requiredSkill: 'Network Engineer', durationMinutes: 60, location: 'Server Room', needsStaged: 'fiber_terminal_sfp', needsTarget: 'RACK_POWERED', onCompleteEffect: { action: 'INSTALL_HARDWARE' } },
